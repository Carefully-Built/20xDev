...
export function HeroSection(): React.ReactElement {
  return (
    <section className="relative min-h-screen overflow-hidden border-b border-black/6">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl items-end px-4 pt-16 pb-20 sm:px-6 md:pb-24 lg:px-8">
        <div className="w-full">
          <div className="mx-auto flex max-w-4xl flex-col items-center gap-8 text-center">
            <div className="inline-flex items-center rounded-full border border-white/25 bg-[rgba(27,6,36,0.62)] px-4 py-1.5 text-sm font-medium tracking-[-0.02em] text-white shadow-[0_10px_30px_rgba(45,32,50,0.14)] backdrop-blur-sm">
              <T>Built for 20x companies</T>
            </div>

            <LandingSectionHeading
              hero
              title={<T>Ship beautiful B2B SaaS in hours, not months</T>}
              description={
                <T>
                  For small AI-native teams that want to move like companies 20 times larger,
                  without rebuilding the same SaaS foundation from scratch.
                </T>
              }
